...
public class SingupActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(SingupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(SingupActivity.this, Main2Activity.class));
                                    finish();
                                }
                            }
                        });
    ...
    private void resetPassword() {
        ...
        final View dialogView = inflater.inflate(R.layout.activity_password_reset_, null);
                ...
                auth.sendPasswordResetEmail(email)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(SingupActivity.this, "We have sent you instructions to reset your password!", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(SingupActivity.this, "Failed to send reset email!", Toast.LENGTH_SHORT).show();
                                }
